...
const Mentor = ({
  ...
  const scheduleHandler = () => {
    if (!item.check) {
      axios
        .post(
          `${GW_URL}/parents/${parentId}/requestMentor`,
          {
            mentor_id: mentor_id,
          },
          parentConfig,
        ...
        <View style={styles.bottomContainer}>
          ...
          {lengthMore ? (
            <Text
              ...
              style={{lineHeight: 20, marginTop: 10, color: 'black'}}>
          ...
          <View style={styles.subRequestContainer}>
            ...
            <View>
              {((item.check && item.check2) ||
                ...
                <TouchableOpacity
                  style={
                    !item.check ? styles.buttonActive : styles.buttonInacitve
                  }
